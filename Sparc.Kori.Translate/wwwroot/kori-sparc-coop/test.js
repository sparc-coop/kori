...
async function saveKoriTextContentAsync(node) {
    ...
    const languageId = node.parentElement ? node.parentElement.lang || navigator.language : navigator.language;
    const id = text + ':' + languageId;

    console.log('detected language', node.parentElement?.lang, navigator.language);
